...
<table border="0" cellspacing="0" cellpadding="0" class="tabellauno">
  ...
  <tr height="20">
        <td style="float:right"><a href='synap_prob/data/nops_values.csv'><img id='csvCN' src='synap_prob/media/ExportCSV.png' width='30px' border='0'/></a></td><td><span style='float:left'><font class='font5'>&nbsp;CSV Number of Potential Synapses Values</font></span></td> 
      </tr> 
