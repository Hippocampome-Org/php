...
for ($i=0; $i<$number_type; $i++) //$number_type // Here he determines the number of active neuron types to print each row in the data table
{
	...
	$responce->rows[$i]['cell']=array('<span style="color:'.$neuronColor[$subregion].'"><strong>'.$neuron[$subregion].'</strong></span>','<a href="neuron_page.php?id='.$id.'" target="blank" title="'.$type->getName().'"><font color="'.$fontColor.'">'.$nickname.'</font></a>','<span style="color:black;float:right">'.$neurite_pattern_soma_location.'</span>',
			...
			getUrlForLink($id,$hippo['AR-beta1'],$name_markers['23'],$hippo_color['AR-beta1']),
			getUrlForLink($id,$hippo['AR-beta2'],$name_markers['24'],$hippo_color['AR-beta2']),
			...
			getUrlForLink($id,$hippo['CGRP'],$name_markers['29'],$hippo_color['CGRP']),
			getUrlForLink($id,$hippo['ChAT'],$name_markers['30'],$hippo_color['ChAT']),
			getUrlForLink($id,$hippo['Chrna2'],$name_markers['31'],$hippo_color['Chrna2']),
			getUrlForLink($id,$hippo['CRF'],$name_markers['32'],$hippo_color['CRF']),
			getUrlForLink($id,$hippo['Ctip2'],$name_markers['33'],$hippo_color['Ctip2']),
			getUrlForLink($id,$hippo['Cx36'],$name_markers['34'],$hippo_color['Cx36']),
			getUrlForLink($id,$hippo['CXCR4'],$name_markers['35'],$hippo_color['CXCR4']),
			getUrlForLink($id,$hippo['Disc1'],$name_markers['36'],$hippo_color['Disc1']),
			getUrlForLink($id,$hippo['DYN'],$name_markers['37'],$hippo_color['DYN']),
			getUrlForLink($id,$hippo['EAAT3'],$name_markers['38'],$hippo_color['EAAT3']),
			getUrlForLink($id,$hippo['ErbB4'],$name_markers['39'],$hippo_color['ErbB4']),
			getUrlForLink($id,$hippo['GABA-B1'],$name_markers['40'],$hippo_color['GABA-B1']),
			getUrlForLink($id,$hippo['GABAa_delta'],$name_markers['41'],$hippo_color['GABAa_delta']),
			...
			getUrlForLink($id,$hippo['GABAa_gamma1'],$name_markers['50'],$hippo_color['GABAa_gamma1']),
			getUrlForLink($id,$hippo['GABAa_gamma2'],$name_markers['51'],$hippo_color['GABAa_gamma2']),
			getUrlForLink($id,$hippo['GAT_1'],$name_markers['52'],$hippo_color['GAT_1']),
			getUrlForLink($id,$hippo['GAT-3'],$name_markers['53'],$hippo_color['GAT-3']),
			getUrlForLink($id,$hippo['GluA1'],$name_markers['54'],$hippo_color['GluA1']),
			getUrlForLink($id,$hippo['GluA2'],$name_markers['55'],$hippo_color['GluA2']),
			getUrlForLink($id,$hippo['GluA3'],$name_markers['56'],$hippo_color['GluA3']),
			getUrlForLink($id,$hippo['GluA4'],$name_markers['57'],$hippo_color['GluA4']),
			getUrlForLink($id,$hippo['GluR2_3'],$name_markers['58'],$hippo_color['GluR2_3']),
			getUrlForLink($id,$hippo['GlyT2'],$name_markers['59'],$hippo_color['GlyT2']),
			getUrlForLink($id,$hippo['Id_2'],$name_markers['60'],$hippo_color['Id_2']),
			getUrlForLink($id,$hippo['Kv3_1'],$name_markers['61'],$hippo_color['Kv3_1']),
			getUrlForLink($id,$hippo['Man1a'],$name_markers['62'],$hippo_color['Man1a']),
			getUrlForLink($id,$hippo['Math-2'],$name_markers['63'],$hippo_color['Math-2']),
			getUrlForLink($id,$hippo['mGluR1'],$name_markers['64'],$hippo_color['mGluR1']),
			getUrlForLink($id,$hippo['mGluR2'],$name_markers['65'],$hippo_color['mGluR2']),
			getUrlForLink($id,$hippo['mGluR2_3'],$name_markers['66'],$hippo_color['mGluR2_3']),
			getUrlForLink($id,$hippo['mGluR3'],$name_markers['67'],$hippo_color['mGluR3']),
			getUrlForLink($id,$hippo['mGluR4'],$name_markers['68'],$hippo_color['mGluR4']),
			getUrlForLink($id,$hippo['mGluR5'],$name_markers['69'],$hippo_color['mGluR5']),
			getUrlForLink($id,$hippo['mGluR5a'],$name_markers['70'],$hippo_color['mGluR5a']),
			getUrlForLink($id,$hippo['mGluR7a'],$name_markers['71'],$hippo_color['mGluR7a']),
			getUrlForLink($id,$hippo['mGluR8a'],$name_markers['72'],$hippo_color['mGluR8a']),
			getUrlForLink($id,$hippo['MOR'],$name_markers['73'],$hippo_color['MOR']),
			getUrlForLink($id,$hippo['Mus1R'],$name_markers['74'],$hippo_color['Mus1R']),
			getUrlForLink($id,$hippo['Mus3R'],$name_markers['75'],$hippo_color['Mus3R']),
			getUrlForLink($id,$hippo['Mus4R'],$name_markers['76'],$hippo_color['Mus4R']),
			getUrlForLink($id,$hippo['NECAB1'],$name_markers['77'],$hippo_color['NECAB1']),
			getUrlForLink($id,$hippo['Neuropilin2'],$name_markers['78'],$hippo_color['Neuropilin2']),
			getUrlForLink($id,$hippo['NKB'],$name_markers['79'],$hippo_color['NKB']),
			getUrlForLink($id,$hippo['p-CREB'],$name_markers['80'],$hippo_color['p-CREB']),
			getUrlForLink($id,$hippo['PCP4'],$name_markers['81'],$hippo_color['PCP4']),
			getUrlForLink($id,$hippo['PPE'],$name_markers['82'],$hippo_color['PPE']),
			getUrlForLink($id,$hippo['PPTA'],$name_markers['83'],$hippo_color['PPTA']),
			getUrlForLink($id,$hippo['PPTB'],$name_markers['84'],$hippo_color['PPTB']),
			getUrlForLink($id,$hippo['Prox1'],$name_markers['85'],$hippo_color['Prox1']),
			getUrlForLink($id,$hippo['PSA-NCAM'],$name_markers['86'],$hippo_color['PSA-NCAM']),
			getUrlForLink($id,$hippo['SATB1'],$name_markers['87'],$hippo_color['SATB1']),
			getUrlForLink($id,$hippo['SATB2'],$name_markers['88'],$hippo_color['SATB2']),
			getUrlForLink($id,$hippo['SCIP'],$name_markers['89'],$hippo_color['SCIP']),
			getUrlForLink($id,$hippo['SPO'],$name_markers['90'],$hippo_color['SPO']),
			getUrlForLink($id,$hippo['SubP'],$name_markers['91'],$hippo_color['SubP']),
			getUrlForLink($id,$hippo['TH'],$name_markers['92'],$hippo_color['TH']),
			getUrlForLink($id,$hippo['vAChT'],$name_markers['93'],$hippo_color['vAChT']),
			getUrlForLink($id,$hippo['vGAT'],$name_markers['94'],$hippo_color['vGAT']),
			getUrlForLink($id,$hippo['vGlut1'],$name_markers['95'],$hippo_color['vGlut1']),
			getUrlForLink($id,$hippo['vGluT2'],$name_markers['96'],$hippo_color['vGluT2']),
			getUrlForLink($id,$hippo['VIAAT'],$name_markers['97'],$hippo_color['VIAAT']),
			getUrlForLink($id,$hippo['VILIP'],$name_markers['98'],$hippo_color['VILIP']),
			getUrlForLink($id,$hippo['Y1'],$name_markers['99'],$hippo_color['Y1'])
			);
