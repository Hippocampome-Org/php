  ...
  */
  ...
  function chk_prop_name($sql, $conn, $tbl) {
    ...
    */
    ...
    properties_included('Theories and Computational<br>Network Models',3,'category','theory_category',$sel_thy,$conn,'multiple','Theories Included','Theories Not Included');    
