  ...
  <script type="text/javascript">
    ...
    function load_keywords(id) {
      ...
      if (id == "subjects_btn") {
        ...
        document.getElementsByName('search_query')[0].value += 'attractor, oscillatory interference, self-organizing map, self organizing map, phase precession, velocity controlled oscillator, controlled oscillator';
      }
...
<body>
  ...
  <div style="width:90%;position:relative;left:5%;"> 
    ...
    echo "</div></input></div></div>";    
    echo "<center>";
    echo "<label style='font-family:arial;font-size:22px;'>Select article or range to search:</label>&nbsp&nbsp<input type='text' name='range' style='width:100px;height:25px;font-size:18px' /><br>";
