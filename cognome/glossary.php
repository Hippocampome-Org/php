<?php
  ...
  $dim_desc=array(
    ...
    3=>"The theory category dimension describes which theories were found to be included in the literature.",
  ...
  /* Subjects */
    ...
    if ($result->num_rows > 0) {       
      while($row = $result->fetch_assoc()) { 
        echo "<tr><td style='min-width:13em;'><center>".$j."</center></td><td style='min-width:10em;'>".$row['subject']."</td></tr>";
        $j++;
      }
    } 
  /* Other dimensions */
