...
class article
{
	...
	public function retrive_by_props($id) 
    {
		/*$table=$this->getName_table();
		...
		{	
			...
			$this->setID(1);
			$this->setPmid_isbn(1234512345);
			$this->setPmcid(123456);
			$this->setNihmsid(123456);
			$this->setDoi(1234512345);
			$this->setOpen_access(123456);
			//$this->setTitle($title);
			$this->setTitle("test2");
			$this->setPublication("test_pub");		
			$this->setVolume("test_vol");
			$this->setIssue("test_iss");
			$this->setFirst_page(1);
			$this->setLast_page(2);			
			$this->setYear(2020);
			$this->setCitation_count(5);
	}
