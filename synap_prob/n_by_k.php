...
if(isset($_GET['tab']) && $_GET['tab'] == 's_d'){
  ...
  $cacheFile = "cache/n_by_k_a_d_l.json";
  $session_variable = "n_by_k_a_d_l";
}
        ...
        for ($j = 0; $j < count($parcel_group) + 1; $j++) {
            ...
            if ($i == 0) {
                ...
                if ($j < 2 || $output_data) {
                    ...
                    switch ($j) {
                        case 4;
                            array_push($final_result, "DG");
                            break;
                        case 16;
                            array_push($final_result, "CA3");
                            break;
                        case 28;
                            array_push($final_result, "CA2");
                            break;
                        case 38;
                            array_push($final_result, "CA1");
                            break;
                        case 46;
                            array_push($final_result, "SUB");
                            break;
                        case 56;
                            array_push($final_result, "EC");
                            break;
                    }
                    
                    array_push($final_result, "</center></font></td>");
                }
            } else if ($i == 1) {
                if ($j == 0) {
                ...
                if ($j == 0) {
                    ...
                    for ($adi = 0; $adi < 2; $adi++) {
                        ...
                        if ($adi == 1) {
                            $j_adj2 = $j_adj + 1;
                            array_push($final_result, "<hr class='hr_sub_cell'>");
                            array_push($final_result, "&nbsp;");
                        }
