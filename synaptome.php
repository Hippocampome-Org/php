...
<p class=MsoNormal>To get the latest updates on the synapse type mapping,</p>
...
style='font:7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</span>Select an experiment, i.e. a block of non-empty rows. Rows 11 to 17 that
are selected in the following figure, for example, belong to one experiment. The
first four columns show the synapse types mapped to the experiment.</p>
...
src="images/synaptome_files/image005.png"></p>

<p class=MsoNormal><span style='position:relative;z-index:251658240'><span
style='position:absolute;left:-21px;top:-7921px;width:128px;height:40px'><img
width=128 height=40 src="images/synaptome_files/image006.png"></span></span><span
style='position:relative;z-index:251658241'><span style='position:absolute;
left:-54px;top:-7921px;width:58px;height:37px'><img width=58 height=37
src="images/synaptome_files/image007.png" alt="(1)"></span></span><span
...
<p class=MsoNormal>The search result should open automatically. The tool
compares the current search engine results with mapping results at the time of
data mining in order to suggest new synapse types to be added (table with blue
header) or deleted (table with red header). You can also <a
href="http://hippocampome.org/php/Help_Search_Engine.php">refine the search
query</a> and repeat the search, save the new query, and sort the tables by
clicking on the column headers.</p>

<p class=MsoNormal><img border=0 width=666 height=606 id="Picture 17"
src="images/synaptome_files/image015.png"></p>

<h1>How to review an experiment and linked references:</h1>
...
<p class=MsoNormal>References are editable but saving them is not automatic. You
need to press save button (<span style='font-family:"Segoe UI Emoji","sans-serif"'>&#128190;</span>)
yourself. After a change the save button will start blinking to remind you that
you need to press save. The red <span style='font-family:"Segoe UI Emoji","sans-serif"'>&#10060;</span>
button removes the HTML text formatting. The <span style='font-family:"Segoe UI Emoji","sans-serif"'>blue
...
<p class=MsoNormal>Confirm your selection.</p>
...
<p class=MsoNormal><img border=0 width=773 height=468 id="Picture 113"
src="images/synaptome_files/image027.png"></p>

<p class=MsoNormal><img border=0 width=458 height=253 id="Picture 114"
src="images/synaptome_files/image028.png"></p>

<p class=MsoNormal>Press OK and wait a minute to see the prefilled form.</p>

<p class=MsoNormal><img border=0 width=870 height=583 id="Picture 115"
src="images/synaptome_files/image029.png"></p>

<p class=MsoNormal>On pressing the submit button, the extracted data will be
saved in the SD tab.</p>

<h1>Reversal Potential and Liquid Junction Potential Calculator</h1>

<p class=MsoNormal>To test the calculator:</p>
...
style='font:7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</span>Uncomment one of the solutions.</p>
...
<p class=MsoNormal><img border=0 width=546 height=302 id="Picture 118"
src="images/synaptome_files/image032.png"></p>
...
<p class=MsoNormal>Assume you want to make a new reference for a text excerpt
from a PDF file.</p>

<p class=MsoNormal><img border=0 width=474 height=134 id="Picture 6"
...
<p class=MsoListParagraph style='text-indent:-.25in'>(2)<span style='font:7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</span>Copy and paste the text you want to clean in the tool window and press
save. Common problems in the text will be corrected, all unnecessary EOLs will
be deleted, and the clean text gets saved in the selected empty Google Sheet cell.
</p>

<p class=MsoNormal><img border=0 width=424 height=448 id="Picture 122"
src="images/synaptome_files/image036.png"></p>

<p class=MsoListParagraph style='text-indent:-.25in'>(3)<span style='font:7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</span>To link the text cleaner tool to another spreadsheet cell you can select
another cell and press the <span style='font-family:"Segoe UI Emoji","sans-serif"'>&#128260;</span>
button.</p>

<p class=MsoNormal>Text Cleaner also gives you access to a list of Unicode
characters often used in scientific reports.</p>

<p class=MsoNormal><img border=0 width=494 height=426 id="Picture 16"
src="images/synaptome_files/image037.png"></p>
...
src="images/synaptome_files/image038.png"></p>

<h1>Data format</h1>

<p class=MsoNormal>We have designed a human- and machine-readable format to
store data entities inspired by common author usage. A single data entity in string
form will look like this:</p>

<p class=MsoNormal style='background:#F2F2F2'>V<sub>1</sub> ± V<sub>2</sub> [V<sub>3</sub>
to V<sub>4</sub>] (n=V<sub>5</sub>) {inner comment}@V<sub>6</sub> {outer
comment}</p>
...
excerpts are joined with comma, as in the following examples.</p>

<table class=PlainTable11 border=1 cellspacing=0 cellpadding=0
 style='border-collapse:collapse;border:none'>
 <tr>
  <td valign=top style='border:solid #BFBFBF 1.0pt;background:#DEEAF6;
  padding:0in 5.4pt 0in 5.4pt'>
  <p class=MsoNormal style='margin-bottom:0in;margin-bottom:.0001pt;line-height:
  normal'><span style='color:#385623'>1.4±0.74(n=7){[Ca²</span><span
  style='font-family:"Cambria Math","serif";color:#385623'>&#8314;</span><span
  style='color:#385623'>]</span><span style='font-family:"Arial","sans-serif";
  color:#385623'>&#8338;</span><span style='color:#385623'>=1}</span><span
  style='color:red'>;</span><span style='color:#385623'> 3.85±0.71(n=7) {[Ca²</span><span
  style='font-family:"Cambria Math","serif";color:#385623'>&#8314;</span><span
  style='color:#385623'>]</span><span style='font-family:"Arial","sans-serif";
  color:#385623'>&#8338;</span><span style='color:#385623'>=2}@3200835{digitized
  and calculated}</span></p>
  </td>
 </tr>
 <tr>
  ...
  <p class=MsoNormal style='margin-bottom:0in;margin-bottom:.0001pt;line-height:
  normal'><span style='color:#385623'>-65.2±17.2(n=7){septal}</span><span
  style='color:red'>;</span><span style='color:#385623'>
  -65.0±8.3(n=17){temporal}@3201035{PVBC</span><span style='font-family:"Arial","sans-serif";
  color:#385623'>&#8594;</span><span style='color:#385623'>dPC:High [Cl</span><span
  style='font-family:"Cambria Math","serif";color:#385623'>&#8315;</span><span
  style='color:#385623'>]</span><span style='font-family:"Arial","sans-serif";
  color:#385623'>&#7522;</span><span style='color:#385623'>}</span></p>
  </td>
 </tr>
 <tr>
  <td valign=top style='border:solid #BFBFBF 1.0pt;border-top:none;background:
  ...
  <p class=MsoNormal style='margin-bottom:0in;margin-bottom:.0001pt;line-height:
  normal'><span style='color:#385623'>-15.2±1.8 [-26.7 to
  -12.8](n=4)@3201032{CCK</span><span style='font-family:"Arial","sans-serif";
  color:#385623'>&#8594;</span><span style='color:#385623'>PV}</span><span
  style='color:red'>,</span><span style='color:#385623'> -12.8</span><span
  style='color:#385623'>±</span><span style='color:#385623'>0.4(n=1)@3201033{CCK</span><span
  style='font-family:"Arial","sans-serif";color:#385623'>&#8594;</span><span
  style='color:#385623'>PV}</span></p>
  </td>
 </tr>
 <tr>
  <td valign=top style='border:solid #BFBFBF 1.0pt;border-top:none;background:
  #F2F2F2;padding:0in 5.4pt 0in 5.4pt'>
  <p class=MsoNormal style='margin-bottom:0in;margin-bottom:.0001pt;line-height:
  normal'><span style='color:#385623'>-32{without Vj correction}</span><span
  style='color:red'>;</span><span style='color:#385623'> -49{with Vj
  correction}@3200666</span><span style='color:red'>&amp;</span><span
  style='color:#385623'>3200667{Vh}</span></p>
  </td>
 </tr>
</table>
...
<p class=MsoNormal style='background:#F2F2F2'><span style='color:#7030A0'>library</span>(dplyr)<br>
js &lt;&lt;- V8::v8()<br>
js$source(<span style='color:#385623'>&quot;parser.js&quot;</span>)<br>
js$call(<span style='color:#385623'>&quot;dataParser&quot;</span>, <span
style='color:#385623'>&quot;1.4±0.74(n=7){[Ca²</span><span style='font-family:
"Cambria Math","serif";color:#385623'>&#8314;</span><span style='color:#385623'>]</span><span
style='font-family:"Arial","sans-serif";color:#385623'>&#8338;</span><span
style='color:#385623'>=1}; 3.85</span><span style='color:#385623'>±</span><span
style='color:#385623'>0.71(n=7) {[Ca</span><span style='color:#385623'>²</span><span
style='font-family:"Cambria Math","serif";color:#385623'>&#8314;</span><span
style='color:#385623'>]</span><span style='font-family:"Arial","sans-serif";
color:#385623'>&#8338;</span><span style='color:#385623'>=2}@3200835{digitized
and calculated}&quot;</span>) <span style='color:#C45911'>%&gt;%</span> <br>
    jsonlite::toJSON() <span style='color:#C45911'>%&gt;%</span> <br>
    jsonlite::prettify()</p>

<p class=MsoNormal>The previous examples in JSON format:</p>
...
<table class=MsoTableGrid border=1 cellspacing=0 cellpadding=0 width="100%"
 ...
 <tr>
  ...
  white;word-break:break-all'><span style='border:none windowtext 1.0pt !msorm;
  padding:0in !msorm'><span style='font-size:10.0pt;font-family:"Lucida Console";
  ...
  white;word-break:break-all'><span style='border:none windowtext 1.0pt !msorm;
  padding:0in !msorm'><span style='font-size:10.0pt;font-family:"Lucida Console";
  color:black'>        &quot;</span></span><span style='border:none windowtext 1.0pt !msorm;
  padding:0in !msorm'><b><span style='font-size:10.0pt;font-family:"Lucida Console";
  color:black'>RefIDs</span></b></span><span style='border:none windowtext 1.0pt !msorm;
  padding:0in !msorm'><span style='font-size:10.0pt;font-family:"Lucida Console";
  color:black'>&quot;: [</span></span></p>
  <p class=MsoNormal style='margin-bottom:0in;margin-bottom:.0001pt;background:
  white;word-break:break-all'><span style='border:none windowtext 1.0pt !msorm;
  padding:0in !msorm'><span style='font-size:10.0pt;font-family:"Lucida Console";
  color:black'>            &quot;3200835&quot;</span></span></p>
  <p class=MsoNormal style='margin-bottom:0in;margin-bottom:.0001pt;background:
  white;word-break:break-all'><span style='border:none windowtext 1.0pt !msorm;
  padding:0in !msorm'><span style='font-size:10.0pt;font-family:"Lucida Console";
  color:black'>        ],</span></span></p>
  ...
  color:black'>        &quot;</span></span><span style='border:none windowtext 1.0pt !msorm;
  padding:0in !msorm'><b><span style='font-size:10.0pt;font-family:"Lucida Console";
  color:black'>note</span></b></span><span style='border:none windowtext 1.0pt !msorm;
  padding:0in !msorm'><span style='font-size:10.0pt;font-family:"Lucida Console";
  color:black'>&quot;: &quot;digitized and calculated&quot;,</span></span></p>
  <p class=MsoNormal style='margin-bottom:0in;margin-bottom:.0001pt;background:
  white;word-break:break-all'><span style='border:none windowtext 1.0pt !msorm;
  padding:0in !msorm'><span style='font-size:10.0pt;font-family:"Lucida Console";
  color:black'>        &quot;</span></span><span style='border:none windowtext 1.0pt !msorm;
  padding:0in !msorm'><b><span style='font-size:10.0pt;font-family:"Lucida Console";
  color:black'>values</span></b></span><span style='border:none windowtext 1.0pt !msorm;
  padding:0in !msorm'><span style='font-size:10.0pt;font-family:"Lucida Console";
  color:black'>&quot;: [</span></span></p>
  <p class=MsoNormal style='margin-bottom:0in;margin-bottom:.0001pt;background:
  white;word-break:break-all'><span style='border:none windowtext 1.0pt !msorm;
  ...
  color:black'>                &quot;</span></span><span style='border:none windowtext 1.0pt !msorm;
  padding:0in !msorm'><b><span style='font-size:10.0pt;font-family:"Lucida Console";
  color:black'>v</span></b></span><span style='border:none windowtext 1.0pt !msorm;
  padding:0in !msorm'><span style='font-size:10.0pt;font-family:"Lucida Console";
  color:black'>&quot;: 1.4,</span></span></p>
  <p class=MsoNormal style='margin-bottom:0in;margin-bottom:.0001pt;background:
  white;word-break:break-all'><span style='border:none windowtext 1.0pt !msorm;
  padding:0in !msorm'><span style='font-size:10.0pt;font-family:"Lucida Console";
  color:black'>                &quot;</span></span><span style='border:none windowtext 1.0pt !msorm;
  padding:0in !msorm'><b><span style='font-size:10.0pt;font-family:"Lucida Console";
  color:black'>s</span></b></span><span style='border:none windowtext 1.0pt !msorm;
  padding:0in !msorm'><span style='font-size:10.0pt;font-family:"Lucida Console";
  color:black'>&quot;: 0.74,</span></span></p>
  <p class=MsoNormal style='margin-bottom:0in;margin-bottom:.0001pt;background:
  white;word-break:break-all'><span style='border:none windowtext 1.0pt !msorm;
  padding:0in !msorm'><span style='font-size:10.0pt;font-family:"Lucida Console";
  color:black'>                &quot;</span></span><span style='border:none windowtext 1.0pt !msorm;
  padding:0in !msorm'><b><span style='font-size:10.0pt;font-family:"Lucida Console";
  color:black'>n</span></b></span><span style='border:none windowtext 1.0pt !msorm;
  padding:0in !msorm'><span style='font-size:10.0pt;font-family:"Lucida Console";
  color:black'>&quot;: 7,</span></span></p>
  <p class=MsoNormal style='margin-bottom:0in;margin-bottom:.0001pt;background:
  white;word-break:break-all'><span style='border:none windowtext 1.0pt !msorm;
  padding:0in !msorm'><span style='font-size:10.0pt;font-family:"Lucida Console";
  color:black'>                &quot;</span></span><span style='border:none windowtext 1.0pt !msorm;
  ...
  color:black'>note</span></b></span><span style='border:none windowtext 1.0pt !msorm;
  padding:0in !msorm'><span style='font-size:10.0pt;font-family:"Lucida Console";
  color:black'>&quot;: &quot;[Ca²</span></span><span style='border:none windowtext 1.0pt !msorm;
  padding:0in !msorm'><span style='font-size:10.0pt;font-family:"Cambria Math","serif";
  color:black'>&#8314;</span></span><span style='border:none windowtext 1.0pt !msorm;
  padding:0in !msorm'><span style='font-size:10.0pt;font-family:"Lucida Console";
  color:black'>]</span></span><span style='border:none windowtext 1.0pt !msorm;
  padding:0in !msorm'><span style='font-size:10.0pt;font-family:"Courier New";
  color:black'>&#8338;</span></span><span style='border:none windowtext 1.0pt !msorm;
  padding:0in !msorm'><span style='font-size:10.0pt;font-family:"Lucida Console";
  color:black'>=1&quot;</span></span></p>
  <p class=MsoNormal style='margin-bottom:0in;margin-bottom:.0001pt;background:
  white;word-break:break-all'><span style='border:none windowtext 1.0pt !msorm;
  padding:0in !msorm'><span style='font-size:10.0pt;font-family:"Lucida Console";
  color:black'>            },</span></span></p>
 ...
 <tr>
  <td width="100%" valign=top style='width:100.0%;border:solid windowtext 1.0pt;
  border-top:none;background:#F2F2F2;padding:0in 5.4pt 0in 5.4pt'><pre
  style='background:white;word-break:break-all'><span style='border:none windowtext 1.0pt !msorm;
  padding:0in !msorm'><span class=gnkrckgcgsb><span style='font-family:"Lucida Console";
  color:black'>[</span></span></span></pre><pre style='background:white;
  word-break:break-all'><span style='border:none windowtext 1.0pt !msorm;
  padding:0in !msorm'><span class=gnkrckgcgsb><span style='font-family:"Lucida Console";
  color:black'>    {</span></span></span></pre><pre style='background:white;
  word-break:break-all'><span style='border:none windowtext 1.0pt !msorm;
  padding:0in !msorm'><span class=gnkrckgcgsb><span style='font-family:"Lucida Console";
  color:black'>        &quot;</span></span></span><span style='border:none windowtext 1.0pt !msorm;
  padding:0in !msorm'><span class=gnkrckgcgsb><b><span style='font-family:"Lucida Console";
  color:black'>RefIDs</span></b></span></span><span style='border:none windowtext 1.0pt !msorm;
  padding:0in !msorm'><span class=gnkrckgcgsb><span style='font-family:"Lucida Console";
  color:black'>&quot;: [</span></span></span></pre><pre style='background:white;
  word-break:break-all'><span style='border:none windowtext 1.0pt !msorm;
  padding:0in !msorm'><span class=gnkrckgcgsb><span style='font-family:"Lucida Console";
  color:black'>            &quot;3201035&quot;</span></span></span></pre><pre
  style='background:white;word-break:break-all'><span style='border:none windowtext 1.0pt !msorm;
  padding:0in !msorm'><span class=gnkrckgcgsb><span style='font-family:"Lucida Console";
  color:black'>        ],</span></span></span></pre><pre style='background:
  white;word-break:break-all'><span style='border:none windowtext 1.0pt !msorm;
  padding:0in !msorm'><span class=gnkrckgcgsb><span style='font-family:"Lucida Console";
  color:black'>        &quot;</span></span></span><span style='border:none windowtext 1.0pt !msorm;
  padding:0in !msorm'><span class=gnkrckgcgsb><b><span style='font-family:"Lucida Console";
  color:black'>note</span></b></span></span><span style='border:none windowtext 1.0pt !msorm;
  padding:0in !msorm'><span class=gnkrckgcgsb><span style='font-family:"Lucida Console";
  color:black'>&quot;: &quot;PVBC&#8594;dPC:High [Cl</span></span></span><span
  style='border:none windowtext 1.0pt !msorm;padding:0in !msorm'><span
  class=gnkrckgcgsb><span style='font-family:"Cambria Math","serif";color:black'>&#8315;</span></span></span><span
  style='border:none windowtext 1.0pt !msorm;padding:0in !msorm'><span
  class=gnkrckgcgsb><span style='font-family:"Lucida Console";color:black'>]</span></span></span><span
  style='border:none windowtext 1.0pt !msorm;padding:0in !msorm'><span
  class=gnkrckgcgsb><span style='color:black'>&#7522;</span></span></span><span
  style='border:none windowtext 1.0pt !msorm;padding:0in !msorm'><span
  class=gnkrckgcgsb><span style='font-family:"Lucida Console";color:black'>&quot;,</span></span></span></pre><pre
  style='background:white;word-break:break-all'><span style='border:none windowtext 1.0pt !msorm;
  padding:0in !msorm'><span class=gnkrckgcgsb><span style='font-family:"Lucida Console";
  color:black'>        &quot;</span></span></span><span style='border:none windowtext 1.0pt !msorm;
  padding:0in !msorm'><span class=gnkrckgcgsb><b><span style='font-family:"Lucida Console";
  color:black'>values</span></b></span></span><span style='border:none windowtext 1.0pt !msorm;
  padding:0in !msorm'><span class=gnkrckgcgsb><span style='font-family:"Lucida Console";
  color:black'>&quot;: [</span></span></span></pre><pre style='background:white;
  word-break:break-all'><span style='border:none windowtext 1.0pt !msorm;
  padding:0in !msorm'><span class=gnkrckgcgsb><span style='font-family:"Lucida Console";
  ...
  style='border:none windowtext 1.0pt !msorm;padding:0in !msorm'><span
  class=gnkrckgcgsb><b><span style='font-family:"Lucida Console";color:black'>v</span></b></span></span><span
  style='border:none windowtext 1.0pt !msorm;padding:0in !msorm'><span
  class=gnkrckgcgsb><span style='font-family:"Lucida Console";color:black'>&quot;: -65.2,</span></span></span></pre><pre
  style='background:white;word-break:break-all'><span style='border:none windowtext 1.0pt !msorm;
  padding:0in !msorm'><span class=gnkrckgcgsb><span style='font-family:"Lucida Console";
  color:black'>                &quot;</span></span></span><span
  style='border:none windowtext 1.0pt !msorm;padding:0in !msorm'><span
  class=gnkrckgcgsb><b><span style='font-family:"Lucida Console";color:black'>s</span></b></span></span><span
  style='border:none windowtext 1.0pt !msorm;padding:0in !msorm'><span
  class=gnkrckgcgsb><span style='font-family:"Lucida Console";color:black'>&quot;: 17.2,</span></span></span></pre><pre
  style='background:white;word-break:break-all'><span style='border:none windowtext 1.0pt !msorm;
  padding:0in !msorm'><span class=gnkrckgcgsb><span style='font-family:"Lucida Console";
  color:black'>                &quot;</span></span></span><span
  style='border:none windowtext 1.0pt !msorm;padding:0in !msorm'><span
  class=gnkrckgcgsb><b><span style='font-family:"Lucida Console";color:black'>n</span></b></span></span><span
  style='border:none windowtext 1.0pt !msorm;padding:0in !msorm'><span
  class=gnkrckgcgsb><span style='font-family:"Lucida Console";color:black'>&quot;: 7,</span></span></span></pre><pre
  style='background:white;word-break:break-all'><span style='border:none windowtext 1.0pt !msorm;
  padding:0in !msorm'><span class=gnkrckgcgsb><span style='font-family:"Lucida Console";
  color:black'>                &quot;</span></span></span><span
  style='border:none windowtext 1.0pt !msorm;padding:0in !msorm'><span
  class=gnkrckgcgsb><b><span style='font-family:"Lucida Console";color:black'>note</span></b></span></span><span
  style='border:none windowtext 1.0pt !msorm;padding:0in !msorm'><span
  class=gnkrckgcgsb><span style='font-family:"Lucida Console";color:black'>&quot;: &quot;septal&quot;</span></span></span></pre><pre
  style='background:white;word-break:break-all'><span style='border:none windowtext 1.0pt !msorm;
  padding:0in !msorm'><span class=gnkrckgcgsb><span style='font-family:"Lucida Console";
  color:black'>            },</span></span></span></pre><pre style='background:
  white;word-break:break-all'><span style='border:none windowtext 1.0pt !msorm;
  ...
  class=gnkrckgcgsb><b><span style='font-family:"Lucida Console";color:black'>v</span></b></span></span><span
  style='border:none windowtext 1.0pt !msorm;padding:0in !msorm'><span
  class=gnkrckgcgsb><span style='font-family:"Lucida Console";color:black'>&quot;: -65,</span></span></span></pre><pre
  style='background:white;word-break:break-all'><span style='border:none windowtext 1.0pt !msorm;
  padding:0in !msorm'><span class=gnkrckgcgsb><span style='font-family:"Lucida Console";
  color:black'>                &quot;</span></span></span><span
  style='border:none windowtext 1.0pt !msorm;padding:0in !msorm'><span
  class=gnkrckgcgsb><b><span style='font-family:"Lucida Console";color:black'>s</span></b></span></span><span
  style='border:none windowtext 1.0pt !msorm;padding:0in !msorm'><span
  class=gnkrckgcgsb><span style='font-family:"Lucida Console";color:black'>&quot;: 8.3,</span></span></span></pre><pre
  style='background:white;word-break:break-all'><span style='border:none windowtext 1.0pt !msorm;
  padding:0in !msorm'><span class=gnkrckgcgsb><span style='font-family:"Lucida Console";
  color:black'>                &quot;</span></span></span><span
  style='border:none windowtext 1.0pt !msorm;padding:0in !msorm'><span
  class=gnkrckgcgsb><b><span style='font-family:"Lucida Console";color:black'>n</span></b></span></span><span
  style='border:none windowtext 1.0pt !msorm;padding:0in !msorm'><span
  class=gnkrckgcgsb><span style='font-family:"Lucida Console";color:black'>&quot;: 17,</span></span></span></pre><pre
  style='background:white;word-break:break-all'><span style='border:none windowtext 1.0pt !msorm;
  padding:0in !msorm'><span class=gnkrckgcgsb><span style='font-family:"Lucida Console";
  color:black'>                &quot;</span></span></span><span
  style='border:none windowtext 1.0pt !msorm;padding:0in !msorm'><span
  class=gnkrckgcgsb><b><span style='font-family:"Lucida Console";color:black'>note</span></b></span></span><span
  style='border:none windowtext 1.0pt !msorm;padding:0in !msorm'><span
  class=gnkrckgcgsb><span style='font-family:"Lucida Console";color:black'>&quot;: &quot;temporal&quot;</span></span></span></pre><pre
  style='background:white;word-break:break-all'><span style='border:none windowtext 1.0pt !msorm;
  padding:0in !msorm'><span class=gnkrckgcgsb><span style='font-family:"Lucida Console";
  color:black'>            }</span></span></span></pre><pre style='background:
  white;word-break:break-all'><span style='border:none windowtext 1.0pt !msorm;
  ...
  word-break:break-all'><span style='border:none windowtext 1.0pt !msorm;
  padding:0in !msorm'><span class=gnkrckgcgsb><span style='font-family:"Lucida Console";
  color:black'>]</span></span></span></pre></td>
 </tr>
 <tr>
  <td width="100%" valign=top style='width:100.0%;border:solid windowtext 1.0pt;
  border-top:none;background:#DEEAF6;padding:0in 5.4pt 0in 5.4pt'><pre
  style='background:white;word-break:break-all'><span style='border:none windowtext 1.0pt !msorm;
  padding:0in !msorm'><span class=gnkrckgcgsb><span style='font-family:"Lucida Console";
  color:black'>[</span></span></span></pre><pre style='background:white;
  word-break:break-all'><span style='border:none windowtext 1.0pt !msorm;
  ...
  word-break:break-all'><span style='border:none windowtext 1.0pt !msorm;
  padding:0in !msorm'><span class=gnkrckgcgsb><span style='font-family:"Lucida Console";
  color:black'>            &quot;3201032&quot;</span></span></span></pre><pre
  style='background:white;word-break:break-all'><span style='border:none windowtext 1.0pt !msorm;
  padding:0in !msorm'><span class=gnkrckgcgsb><span style='font-family:"Lucida Console";
  color:black'>        ],</span></span></span></pre><pre style='background:
  white;word-break:break-all'><span style='border:none windowtext 1.0pt !msorm;
  ...
  color:black'>note</span></b></span></span><span style='border:none windowtext 1.0pt !msorm;
  padding:0in !msorm'><span class=gnkrckgcgsb><span style='font-family:"Lucida Console";
  color:black'>&quot;: &quot;CCK&#8594;PV&quot;,</span></span></span></pre><pre
  style='background:white;word-break:break-all'><span style='border:none windowtext 1.0pt !msorm;
  padding:0in !msorm'><span class=gnkrckgcgsb><span style='font-family:"Lucida Console";
  color:black'>        &quot;</span></span></span><span style='border:none windowtext 1.0pt !msorm;
  padding:0in !msorm'><span class=gnkrckgcgsb><b><span style='font-family:"Lucida Console";
  ...
  class=gnkrckgcgsb><b><span style='font-family:"Lucida Console";color:black'>v</span></b></span></span><span
  style='border:none windowtext 1.0pt !msorm;padding:0in !msorm'><span
  class=gnkrckgcgsb><span style='font-family:"Lucida Console";color:black'>&quot;: -15.2,</span></span></span></pre><pre
  style='background:white;word-break:break-all'><span style='border:none windowtext 1.0pt !msorm;
  padding:0in !msorm'><span class=gnkrckgcgsb><span style='font-family:"Lucida Console";
  color:black'>                &quot;</span></span></span><span
  style='border:none windowtext 1.0pt !msorm;padding:0in !msorm'><span
  class=gnkrckgcgsb><b><span style='font-family:"Lucida Console";color:black'>s</span></b></span></span><span
  style='border:none windowtext 1.0pt !msorm;padding:0in !msorm'><span
  class=gnkrckgcgsb><span style='font-family:"Lucida Console";color:black'>&quot;: 1.8,</span></span></span></pre><pre
  style='background:white;word-break:break-all'><span style='border:none windowtext 1.0pt !msorm;
  padding:0in !msorm'><span class=gnkrckgcgsb><span style='font-family:"Lucida Console";
  color:black'>                &quot;</span></span></span><span
  style='border:none windowtext 1.0pt !msorm;padding:0in !msorm'><span
  class=gnkrckgcgsb><b><span style='font-family:"Lucida Console";color:black'>ll</span></b></span></span><span
  style='border:none windowtext 1.0pt !msorm;padding:0in !msorm'><span
  class=gnkrckgcgsb><span style='font-family:"Lucida Console";color:black'>&quot;: -26.7,</span></span></span></pre><pre
  style='background:white;word-break:break-all'><span style='border:none windowtext 1.0pt !msorm;
  padding:0in !msorm'><span class=gnkrckgcgsb><span style='font-family:"Lucida Console";
  color:black'>                &quot;</span></span></span><span
  style='border:none windowtext 1.0pt !msorm;padding:0in !msorm'><span
  class=gnkrckgcgsb><b><span style='font-family:"Lucida Console";color:black'>ul</span></b></span></span><span
  style='border:none windowtext 1.0pt !msorm;padding:0in !msorm'><span
  class=gnkrckgcgsb><span style='font-family:"Lucida Console";color:black'>&quot;: -12.8,</span></span></span></pre><pre
  style='background:white;word-break:break-all'><span style='border:none windowtext 1.0pt !msorm;
  padding:0in !msorm'><span class=gnkrckgcgsb><span style='font-family:"Lucida Console";
  color:black'>                &quot;</span></span></span><span
  style='border:none windowtext 1.0pt !msorm;padding:0in !msorm'><span
  class=gnkrckgcgsb><b><span style='font-family:"Lucida Console";color:black'>n</span></b></span></span><span
  style='border:none windowtext 1.0pt !msorm;padding:0in !msorm'><span
  class=gnkrckgcgsb><span style='font-family:"Lucida Console";color:black'>&quot;: 4,</span></span></span></pre><pre
  style='background:white;word-break:break-all'><span style='border:none windowtext 1.0pt !msorm;
  padding:0in !msorm'><span class=gnkrckgcgsb><span style='font-family:"Lucida Console";
  color:black'>                &quot;</span></span></span><span
  style='border:none windowtext 1.0pt !msorm;padding:0in !msorm'><span
  ...
  color:black'>            &quot;</span></span></span><span style='border:none windowtext 1.0pt !msorm;
  padding:0in !msorm'><span class=gnkrckgcgsb><b><span style='font-family:"Lucida Console";
  color:black'>3201033</span></b></span></span><span style='border:none windowtext 1.0pt !msorm;
  padding:0in !msorm'><span class=gnkrckgcgsb><span style='font-family:"Lucida Console";
  color:black'>&quot;</span></span></span></pre><pre style='background:white;
  word-break:break-all'><span style='border:none windowtext 1.0pt !msorm;
  padding:0in !msorm'><span class=gnkrckgcgsb><span style='font-family:"Lucida Console";
  ...
  class=gnkrckgcgsb><b><span style='font-family:"Lucida Console";color:black'>s</span></b></span></span><span
  style='border:none windowtext 1.0pt !msorm;padding:0in !msorm'><span
  class=gnkrckgcgsb><span style='font-family:"Lucida Console";color:black'>&quot;: 0.4,</span></span></span></pre><pre
  style='background:white;word-break:break-all'><span style='border:none windowtext 1.0pt !msorm;
  padding:0in !msorm'><span class=gnkrckgcgsb><span style='font-family:"Lucida Console";
  color:black'>                &quot;</span></span></span><span
  style='border:none windowtext 1.0pt !msorm;padding:0in !msorm'><span
  class=gnkrckgcgsb><b><span style='font-family:"Lucida Console";color:black'>n</span></b></span></span><span
  style='border:none windowtext 1.0pt !msorm;padding:0in !msorm'><span
  class=gnkrckgcgsb><span style='font-family:"Lucida Console";color:black'>&quot;: 1,</span></span></span></pre><pre
  style='background:white;word-break:break-all'><span style='border:none windowtext 1.0pt !msorm;
  padding:0in !msorm'><span class=gnkrckgcgsb><span style='font-family:"Lucida Console";
  color:black'>                &quot;</span></span></span><span
  style='border:none windowtext 1.0pt !msorm;padding:0in !msorm'><span
 ...
 <tr>
  ...
  word-break:break-all'><span style='border:none windowtext 1.0pt !msorm;
  padding:0in !msorm'><span class=gnkrckgcgsb><span style='font-family:"Lucida Console";
  color:black'>            &quot;3200666&quot;,</span></span></span></pre><pre
  style='background:white;word-break:break-all'><span style='border:none windowtext 1.0pt !msorm;
  padding:0in !msorm'><span class=gnkrckgcgsb><span style='font-family:"Lucida Console";
  color:black'>            &quot;3200667&quot;</span></span></span></pre><pre
  style='background:white;word-break:break-all'><span style='border:none windowtext 1.0pt !msorm;
  padding:0in !msorm'><span class=gnkrckgcgsb><span style='font-family:"Lucida Console";
  color:black'>        ],</span></span></span></pre><pre style='background:
  white;word-break:break-all'><span style='border:none windowtext 1.0pt !msorm;
  ...
  color:black'>note</span></b></span></span><span style='border:none windowtext 1.0pt !msorm;
  padding:0in !msorm'><span class=gnkrckgcgsb><span style='font-family:"Lucida Console";
  color:black'>&quot;: &quot;Vh&quot;,</span></span></span></pre><pre
  style='background:white;word-break:break-all'><span style='border:none windowtext 1.0pt !msorm;
  padding:0in !msorm'><span class=gnkrckgcgsb><span style='font-family:"Lucida Console";
  color:black'>        &quot;</span></span></span><span style='border:none windowtext 1.0pt !msorm;
  padding:0in !msorm'><span class=gnkrckgcgsb><b><span style='font-family:"Lucida Console";
  ...
  class=gnkrckgcgsb><b><span style='font-family:"Lucida Console";color:black'>v</span></b></span></span><span
  style='border:none windowtext 1.0pt !msorm;padding:0in !msorm'><span
  class=gnkrckgcgsb><span style='font-family:"Lucida Console";color:black'>&quot;: -32,</span></span></span></pre><pre
  style='background:white;word-break:break-all'><span style='border:none windowtext 1.0pt !msorm;
  padding:0in !msorm'><span class=gnkrckgcgsb><span style='font-family:"Lucida Console";
  color:black'>                &quot;</span></span></span><span
  style='border:none windowtext 1.0pt !msorm;padding:0in !msorm'><span
  class=gnkrckgcgsb><b><span style='font-family:"Lucida Console";color:black'>note</span></b></span></span><span
  style='border:none windowtext 1.0pt !msorm;padding:0in !msorm'><span
  class=gnkrckgcgsb><span style='font-family:"Lucida Console";color:black'>&quot;: &quot;without Vj correction&quot;</span></span></span></pre><pre
  style='background:white;word-break:break-all'><span style='border:none windowtext 1.0pt !msorm;
  padding:0in !msorm'><span class=gnkrckgcgsb><span style='font-family:"Lucida Console";
  color:black'>            },</span></span></span></pre><pre style='background:
  white;word-break:break-all'><span style='border:none windowtext 1.0pt !msorm;
  ...
  class=gnkrckgcgsb><b><span style='font-family:"Lucida Console";color:black'>v</span></b></span></span><span
  style='border:none windowtext 1.0pt !msorm;padding:0in !msorm'><span
  class=gnkrckgcgsb><span style='font-family:"Lucida Console";color:black'>&quot;: -49,</span></span></span></pre><pre
  style='background:white;word-break:break-all'><span style='border:none windowtext 1.0pt !msorm;
  padding:0in !msorm'><span class=gnkrckgcgsb><span style='font-family:"Lucida Console";
  color:black'>                &quot;</span></span></span><span
  style='border:none windowtext 1.0pt !msorm;padding:0in !msorm'><span
  class=gnkrckgcgsb><b><span style='font-family:"Lucida Console";color:black'>note</span></b></span></span><span
  style='border:none windowtext 1.0pt !msorm;padding:0in !msorm'><span
  class=gnkrckgcgsb><span style='font-family:"Lucida Console";color:black'>&quot;: &quot;with Vj correction&quot;</span></span></span></pre><pre
  style='background:white;word-break:break-all'><span style='border:none windowtext 1.0pt !msorm;
  padding:0in !msorm'><span class=gnkrckgcgsb><span style='font-family:"Lucida Console";
  color:black'>            }</span></span></span></pre><pre style='background:
  white;word-break:break-all'><span style='border:none windowtext 1.0pt !msorm;
