...
<style>
#nGrid_PV,#nGrid_vGluT2,#nGrid_VIP,#nGrid_RLN,#nGrid_Neuron type
{
...
$(function()
{
	...
	$("#nGrid").jqGrid(
	{
		...
		[
			...
			{name:'Encoding', index:'Encoding', width:50,sortable:false},
			...
			{name:'vGluT3',index:'vGluT3',width:15,height:150,search:false,sortable:false,hidden:true},
	...
	jQuery("#nGrid").jqGrid('setGroupHeaders', { useColSpanStyle: true, 
		groupHeaders:[ 
		{startColumnName: 'CB', numberOfColumns: 3, titleText: '<b><a id="dg_subregion" href="parcel_page.php?subregion=DG&type=subregion" onClick="OpenInNewTab(this);" >Ca2+ binding proteins</a><b>'},
		{startColumnName: '5HT-3', numberOfColumns: 7, titleText: '<b><a id="ca3_subregion" href="parcel_page.php?subregion=CA3&type=subregion" onClick="OpenInNewTab(this);">Receptors/Transporters</a></b>'},
		{startColumnName: 'CCK', numberOfColumns: 6, titleText: '<b><a id="ca2_subregion" href="parcel_page.php?subregion=CA2&type=subregion" onClick="OpenInNewTab(this);">Neuro-peptides</a></b>'},
		{startColumnName: 'a-act2', numberOfColumns: 4, titleText: '<b><a id="ca1_subregion" href="parcel_page.php?subregion=CA1&type=subregion" onClick="OpenInNewTab(this);">Misc</a></b>'},
		] 
	});
	if(checkVersion()=="9")
	{
...
<div class='title_area_marker'>
	...
	<div align="right" style="margin-top:-20px;color:#000099">
		<form id="myform">
			<input type="checkbox" name="check1" value="check1" style="background-color: #000099;margin-right:-56px">
		</form>
		<div align="right" style="margin-top:-20px;margin-right:-170px;color:#000099">Check to expand</div>
	</div>
</div>
