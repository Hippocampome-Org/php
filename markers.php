...
$(function(){
    ...
    colModel :[
      ...
      {name:'SubP', index:'SubP', width:15,height:150,search:false,sortable:false},
   ...
   /*  sortname: 'invid',
	...
	if(checkVersion()=="9")
	{
		...
		$("#jqgh_nGrid_SubP").addClass("rotateIE9");
	...
	else
	{
		...
		$("#jqgh_nGrid_SubP").addClass("rotate");
