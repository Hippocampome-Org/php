...
//var colPos = 20;
   ...
   /* alert(a[0].name);
    ...
    alert(a[1].name);
    alert(a[1].width);*/
  //  myGrid.jqGrid('setColProp','amount',{width:80%});
   // myGrid.jqGrid('setGridWidth',"80%");
...
<!--		<input type="button" id="btnHide" disabled value="Hide Column" onclick="HideColumn();" />
	<input type="button" id="btnShow" disabled value="Show Column" onclick="ShowColumn();" />-->
</div>
